...
<body>
    ...
    <nav class="navbar">
        ...
        <div class="navbar-links">
            <ul>
            <li>
            <a href="../../../About.html" class="nav-aboutus">About Us</a></li>
    ...
    <div class="main-container">
        <div class="container">
            ...
            <div class="main-img">
                <img src="image/m2.jpeg" id="current" class="current-size">
            </div>
      </div>
    </div>
    <!--Product End-->
    ...
    <div class="des-container">
        <div class="prod-disc">
        <h1>Endgame Gear XM1r</h1>
        <h2>Endgame Gear</h2>
        <h2>₱ 3100.00</h2>
        <p>Ambidextrous Design</p>
        <p>Pixart 3370 20K Sensor</p>
        <p>Fully customizable keys with software</p>
        <p>Kailh GM 8.0 switches</p>
        </div>
