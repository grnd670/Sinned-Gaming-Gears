...
<body>
    ...
    <div class="main-container">
        <div class="container">
            <div class="imgs">
                <img src="image/h1.5.png">
                <img src="image/headset 3.png">
                <img src="image/h2.png">
                <img src="image/h4.png">
            </div>
            <div class="main-img">
                <img src="image/h1.5.png" id="current" class="current-size">
            </div>
      </div>
    </div>
    <!--Product End-->
    ...
    <div class="des-container">
        <div class="prod-disc">
        <h1>Logitech G733 Headset</h1>
        <h2>Logitech</h2>
        <h2>₱ 8000.00</h2>
        <p>Logitech's Wireless Gaming Headset</p>
        <p>Lightsync RGB</p>
        <p>Blue VO!CE real-time voice filter microphone</p> 
        <p>Lightweight headset</p>
        </div>
        <div class="des-container-btn">
            <div class="btn-container">
                <a href="../../../Payment.php">Buy Now</a>
                <a class="add-to-cart" href="../../../Product Selection.php">Product Selection</a>
            </div>
        </div>
    </div>
