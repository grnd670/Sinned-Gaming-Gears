...
<body>
    ...
    <div class="main-container">
        <div class="container">
            <div class="imgs">
                ...
                <img src="image/keyboard 5.1.png">
                <img src="image/keyboard 5.3.png">
            </div>
            <div class="main-img">
                <img src="image/4.jpeg" id="current" class="current-size">
            </div>
      </div>
    </div>
    <!--Product End-->
    ...
    <div class="des-container">
        <div class="prod-disc">
        <h1>Razer Hunstman Mini</h1>
        <h2>Razer</h2>
        <h2>₱ 5300.00</h2>
        <p>Razer Optical Switches</p>
        <p>60% Gaming Keyboard</p>
